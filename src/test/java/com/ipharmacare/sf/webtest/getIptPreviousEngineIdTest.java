...
public class getIptPreviousEngineIdTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,engineId=null;
    getIptPreviousEngineId req=new getIptPreviousEngineId();
    
    
    @Parameters({"engineId"})
	@Test(groups = { "BaseCase1"})
    public void getIptPreviousEngineId_Succ(String engineId) throws Exception{
