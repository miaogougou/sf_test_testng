...
public class getIptAroundAuditResultIdallTest {
    
    public String Code=null,Data=null,OptRecipeInfo=null,Result=null,id=null;
    getIptAroundAuditResultIdall req=new getIptAroundAuditResultIdall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptAroundAuditResultIdall_Succ(String id) throws Exception{
