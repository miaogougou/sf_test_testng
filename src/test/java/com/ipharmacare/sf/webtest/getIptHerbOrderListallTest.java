...
public class getIptHerbOrderListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptHerbOrderListall req=new getIptHerbOrderListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptHerbOrderListall_Succ(String id) throws Exception{
