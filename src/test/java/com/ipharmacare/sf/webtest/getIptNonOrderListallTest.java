...
public class getIptNonOrderListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptNonOrderListall req=new getIptNonOrderListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptNonOrderListall_Succ(String id) throws Exception{
