...
public class getIptBacterialListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptBacterialListall req=new getIptBacterialListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptBacterialListall_Succ(String id) throws Exception{
