...
public class getDrugPropertyTreeTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,keyword=null;
    getDrugPropertyTree req=new getDrugPropertyTree();
    
    
    @Parameters({"keyword"})
	@Test(groups = { "BaseCase1"})
    public void getDrugPropertyTree_Succ(String keyword) throws Exception{
