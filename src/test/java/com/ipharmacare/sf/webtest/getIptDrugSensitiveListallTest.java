...
public class getIptDrugSensitiveListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptDrugSensitiveListall req=new getIptDrugSensitiveListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptDrugSensitiveListall_Succ(String id) throws Exception{
