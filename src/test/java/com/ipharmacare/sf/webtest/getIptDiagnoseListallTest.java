...
public class getIptDiagnoseListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptDiagnoseListall req=new getIptDiagnoseListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptDiagnoseListall_Succ(String id) throws Exception{
