...
public class getOptTotalCheckNumTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,projectId=null;
    getOptTotalCheckNum req=new getOptTotalCheckNum();
    
    
    @Parameters({"projectId"})
	@Test(groups = { "BaseCase1"})
    public void getOptTotalCheckNum_Succ(String projectId) throws Exception{
