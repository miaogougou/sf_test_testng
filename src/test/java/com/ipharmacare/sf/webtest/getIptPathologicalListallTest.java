...
public class getIptPathologicalListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptPathologicalListall req=new getIptPathologicalListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptPathologicalListall_Succ(String id) throws Exception{
