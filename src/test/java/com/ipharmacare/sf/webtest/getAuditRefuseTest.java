...
public class getAuditRefuseTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getAuditRefuse req=new getAuditRefuse();
    
    
    @Parameters({"id","auditType"})
	@Test(groups = { "BaseCase1"})
    public void getAuditRefuse_Succ(String id,String auditType) throws Exception{
        resultCheck(id,auditType,StatusInfo.REQUEST_SUCCESS); 
    }
     
    public void resultCheck(String id,String auditType, StatusInfo statusInfo ) throws Exception{
        Result=req.getHttpRespone(id,auditType);  
