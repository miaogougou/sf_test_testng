...
public class getIptPathologicalListTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptPathologicalList req=new getIptPathologicalList();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptPathologicalList_Succ(String id) throws Exception{
