...
public class getChildDrugPropertyTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,keyword=null;
    getChildDrugProperty req=new getChildDrugProperty();
    
    
    @Parameters({"keyword"})
	@Test(groups = { "BaseCase1"})
    public void getChildDrugProperty_Succ(String keyword) throws Exception{
