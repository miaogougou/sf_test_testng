...
public class getWorkStatisticsExportTest {
    
    public String Code=null,Data=null,Msg=null,Result=null;
    getWorkStatisticsExport req=new getWorkStatisticsExport();
    
    @Test(groups = { "BaseCase1"})
    public void getWorkStatisticsExport_Succ() throws Exception{
