...
public class postAuditBatchAgreeTest {
    
    public String Code=null,Data=null,Msg=null,Result=null;
   
    postAuditBatchAgree req=new postAuditBatchAgree();
    /**
     * 
     * @Title: PostAuditBatchAgree_Succ 
    ...
    public void PostAuditBatchAgree_Succ() throws Exception{
