...
public class getIptVitalSignListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptVitalSignListall req=new getIptVitalSignListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptVitalSignListall_Succ(String id) throws Exception{
