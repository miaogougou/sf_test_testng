...
public class getIptProgressListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptProgressListall req=new getIptProgressListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptProgressListall_Succ(String id) throws Exception{
