...
public class getCheckRuleTest {
    
    public String Code=null,Data=null,Msg=null,Result=null;
    getCheckRule req=new getCheckRule();
    
    @Test(groups = { "BaseCase1"})
    public void getCheckRule_Succ() throws Exception{
    ...
    public void resultCheck( StatusInfo statusInfo ) throws Exception{
        ...
        Assert.assertEquals(Data,"http://120.26.216.119:8061/base/ruleEditor.action");
    }
}
