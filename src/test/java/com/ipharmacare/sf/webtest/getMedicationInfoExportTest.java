...
public class getMedicationInfoExportTest {
    
    public String Code=null,Data=null,Msg=null,Result=null;
    getMedicationInfoExport req=new getMedicationInfoExport();
    
    @Test(groups = { "BaseCase1"})
    public void getMedicationInfoExport_Succ() throws Exception{
