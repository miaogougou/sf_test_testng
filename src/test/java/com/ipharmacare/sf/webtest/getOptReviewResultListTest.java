...
public class getOptReviewResultListTest {
    
    public String Code=null,Data=null,Msg=null,Result=null;
    getOptReviewResultList req=new getOptReviewResultList();
    
    
    @Parameters({"startTime","endTime","page","pageSize",
				"checkPeopleName","checkResult","source"})
	@Test(groups = { "BaseCase1"})
    public void getOptReviewResultList_Succ(String startTime,String endTime,
