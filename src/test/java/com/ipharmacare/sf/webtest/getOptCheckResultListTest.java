...
public class getOptCheckResultListTest {
    
    public String Code=null,Data=null,OptRecipeInfo=null,Result=null,projectId=null;
    getOptCheckResultList req=new getOptCheckResultList();
    
    
    @Parameters({"projectId","page","pageSize","checkStatus"})
	@Test(groups = { "BaseCase1"})
    public void getOptCheckResultList_Succ(String projectId,String page,String pageSize,String checkStatus) throws Exception{
