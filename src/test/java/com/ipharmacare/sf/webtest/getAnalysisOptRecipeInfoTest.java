...
public class getAnalysisOptRecipeInfoTest {
    
    public String Code=null,Data=null,OptRecipeInfo=null,Result=null,optRecipeId=null;
    getAnalysisOptRecipeInfo req=new getAnalysisOptRecipeInfo();
    
    
    @Parameters({"optRecipeId"})
	@Test(groups = { "BaseCase1"})
    public void getAnalysisOptRecipeInfo_Succ(String optRecipeId) throws Exception{
