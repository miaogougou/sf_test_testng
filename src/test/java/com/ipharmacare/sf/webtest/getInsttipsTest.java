...
public class getInsttipsTest {
    
    public String Code=null,Data=null,Msg=null,Result=null;
    getInsttips req=new getInsttips();
    
    @Test(groups = { "BaseCase1"})
    public void getInsttips_Succ() throws Exception{
    ...
    public void resultCheck( StatusInfo statusInfo ) throws Exception{
        ...
        Assert.assertEquals(Data,"http://120.26.216.119:8061/zlcx/data_detail.action");
    }
}
