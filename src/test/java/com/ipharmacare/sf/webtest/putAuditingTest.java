...
public class putAuditingTest {
    
    public String Code=null,Data=null,Msg=null,Result=null;
    putAuditing req=new putAuditing();
    
    
    @Parameters({"Ids"})
	@Test(groups = { "BaseCase1"})
    public void putAuditing_Succ(String Ids) throws Exception{
        resultCheck(Ids,StatusInfo.REQUEST_SUCCESS); 
    }
     
    public void resultCheck(String Ids,StatusInfo statusInfo ) throws Exception{
