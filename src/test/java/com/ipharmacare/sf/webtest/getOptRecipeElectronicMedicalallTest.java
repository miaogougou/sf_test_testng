...
public class getOptRecipeElectronicMedicalallTest {
    
    public String Code=null,Data=null,OptRecipeElectronicMedicalall=null,Result=null,optRecipeId=null;
    getOptRecipeElectronicMedicalall req=new getOptRecipeElectronicMedicalall();
    
    
    @Parameters({"optRecipeId"})
	@Test(groups = { "BaseCase1"})
    public void getOptRecipeElectronicMedicalall_Succ(String optRecipeId) throws Exception{
    ...
    public void resultCheck(String optRecipeId, StatusInfo statusInfo ) throws Exception{
        ...
        OptRecipeElectronicMedicalall=Common.getJsonValue(Result, "message");
        if(null != statusInfo ) {
        	Assert.assertEquals(Code,statusInfo.getCode()); 
            Assert.assertEquals(OptRecipeElectronicMedicalall,statusInfo.getMessage());
        }
    }
}
