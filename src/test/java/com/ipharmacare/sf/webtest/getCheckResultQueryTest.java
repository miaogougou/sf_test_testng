...
public class getCheckResultQueryTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,projectId=null;
    getCheckResultQuery req=new getCheckResultQuery();
    
    
    @Parameters({"projectId"})
	@Test(groups = { "BaseCase1"})
    public void  getCheckResultQuery_Succ(String projectId) throws Exception{
