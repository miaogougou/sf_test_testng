...
public class getCheckIptOrderDataTest {
    
    public String Code=null,Data=null,OptRecipeInfo=null,Result=null,id=null;
    getCheckIptOrderData req=new getCheckIptOrderData();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getCheckIptOrderData_Succ(String id) throws Exception{
