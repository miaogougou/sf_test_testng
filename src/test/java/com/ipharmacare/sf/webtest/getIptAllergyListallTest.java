...
public class getIptAllergyListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptAllergyListall req=new getIptAllergyListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptAllergyListall_Succ(String id) throws Exception{
