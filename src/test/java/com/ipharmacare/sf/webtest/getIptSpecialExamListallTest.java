...
public class getIptSpecialExamListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptSpecialExamListall req=new getIptSpecialExamListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptSpecialExamListall_Succ(String id) throws Exception{
