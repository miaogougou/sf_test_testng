...
public class getChildDrugCategoryTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,parentid=null;
    getChildDrugCategory req=new getChildDrugCategory();
    
    
    @Parameters({"parentid"})
	@Test(groups = { "BaseCase1"})
    public void getChildDrugCategory_Succ(String parentid) throws Exception{
