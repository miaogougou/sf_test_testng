...
public class getIptCreateProjectReportTest {
    
    public String Code=null,Data=null,OptRecipeInfo=null,Result=null,projectId=null;
    getIptCreateProjectReport req=new getIptCreateProjectReport();
    
    
    @Parameters({"projectId"})
	@Test(groups = { "BaseCase1"})
    public void getIptCreateProjectReport_Succ(String projectId) throws Exception{
