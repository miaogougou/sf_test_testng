...
public class postAuditBatchPendingTest {
    
    public String Code=null,Data=null,Msg=null,Result=null;
   
    postAuditBatchPending req=new postAuditBatchPending();
    /**
     * 
     * @Title: PostAuditBatchPending_Succ 
    ...
    public void PostAuditBatchPending_Succ() throws Exception{
