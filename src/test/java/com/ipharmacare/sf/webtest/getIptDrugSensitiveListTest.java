...
public class getIptDrugSensitiveListTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptDrugSensitiveList req=new getIptDrugSensitiveList();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptDrugSensitiveList_Succ(String id) throws Exception{
