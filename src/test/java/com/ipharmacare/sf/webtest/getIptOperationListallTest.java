...
public class getIptOperationListallTest {
    
    public String Code=null,Data=null,Msg=null,Result=null,id=null;
    getIptOperationListall req=new getIptOperationListall();
    
    
    @Parameters({"id"})
	@Test(groups = { "BaseCase1"})
    public void getIptOperationListall_Succ(String id) throws Exception{
