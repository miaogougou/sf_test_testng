...
public class getMsgTest {
    ...
    public String Code=null,Data=null,Msg=null,Result=null,messageId=null;
    getMsg req=new getMsg();
    
    
    @Parameters({"messageId"})
	@Test(groups = { "BaseCase1"})
    public void getMsg_Succ(String messageId) throws Exception{
        resultCheck(messageId,StatusInfo.REQUEST_SUCCESS); 
    }
     
    public void resultCheck(String messageId, StatusInfo statusInfo ) throws Exception{
        Result=req.getHttpRespone(messageId);  
