...
public class putOpenAlertMsgDpRemarkTest {
    
    public String Code=null,Data=null,Msg=null,Result=null;
    putOpenAlertMsgDpRemark req=new putOpenAlertMsgDpRemark();
    
    
    @Parameters({"messageId","applyType"})
	@Test(groups = { "BaseCase1"})
    public void putOpenAlertMsgDpRemark_Succ(String messageId,String applyType) throws Exception{
        resultCheck(messageId,applyType,StatusInfo.REQUEST_SUCCESS); 
    }
     
    public void resultCheck(String messageId,String applyType,StatusInfo statusInfo ) throws Exception{
        Result=req.getHttpRespone(messageId,applyType);  
