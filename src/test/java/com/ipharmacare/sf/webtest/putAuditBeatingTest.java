...
public class putAuditBeatingTest {
    
    public String Code=null,Data=null,Msg=null,Result=null;
    putAuditBeating req=new putAuditBeating();
    
    
	@Test(groups = { "BaseCase1"})
    public void putAuditBeating_Succ() throws Exception{
        resultCheck(null,StatusInfo.REQUEST_SUCCESS); 
    }
