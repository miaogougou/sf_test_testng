...
public class getCheckResultQuery {	
    ...
    public String getHttpRespone(String projectId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/getCheckResultQuery"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("getCheckResultQuery form get: " + response.getStatusLine());
