...
public class postAuditBatchAgree {	
    ...
    public String getHttpRespone(String body) throws IOException {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/auditBatchAgree");
        ...
        try {
            ...
            try {
                ...
                System.out.println("auditBatchAgree form post: " + response.getStatusLine());
