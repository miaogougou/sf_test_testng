...
public class getOptEngineMsgListall {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/all/engineMsgList/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("engineMsgListall form get: " + response.getStatusLine());
