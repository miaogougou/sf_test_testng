...
/**
 * 
 * @ClassName: getIptVitalSignListall 
 * @Description: 获取生命体征列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptVitalSignListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/vitalSignList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("vitalSignListall form get: " + response.getStatusLine());
