...
/**
 * 
 * @ClassName: getOptAlreadyCheckNum 
 * @Descroption: 门诊已复核数
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getOptAlreadyCheckNum {	
	private String url="";
	/**
	 * @Title: geturl 
	 * @Descroption: 访问的URL的getter方法 
	 * @param @return    设定文件 
	 * @return String    返回类型 
	 * @throws
	 */
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/opt/getAlreadyCheckNum"); 
