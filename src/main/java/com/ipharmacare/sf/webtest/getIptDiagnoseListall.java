...
/**
 * 
 * @ClassName: getIptDiagnoseListall 
 * @Description: 获取诊断信息列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptDiagnoseListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/diagnoseList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("diagnoseListall form get: " + response.getStatusLine());
