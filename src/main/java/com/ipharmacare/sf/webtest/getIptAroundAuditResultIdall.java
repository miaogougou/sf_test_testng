...
public class getIptAroundAuditResultIdall {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/aroundAuditResultId"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("aroundAuditResultId form get: " + response.getStatusLine());
