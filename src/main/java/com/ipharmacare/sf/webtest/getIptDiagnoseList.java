...
public class getIptDiagnoseList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/diagnoseList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("diagnoseList form get: " + response.getStatusLine());
