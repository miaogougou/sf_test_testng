...
public class getDeleteExportList {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/deleteExportList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("deleteExportList form get: " + response.getStatusLine());
