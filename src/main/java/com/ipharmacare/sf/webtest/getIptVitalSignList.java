...
public class getIptVitalSignList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/vitalSignList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("vitalSignList form get: " + response.getStatusLine());
