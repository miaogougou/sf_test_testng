...
/**
 * 
 * @ClassName: getIptInfoAggregation 
 * @Description: 获取住院汇总
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptInfoAggregation {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id,String startDate,String period) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/iptInfoAggregation"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("iptInfoAggregation form get: " + response.getStatusLine());
