...
public class putEndOfAudit {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/endOfAudit"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("EndOfAudit form get: " + response.getStatusLine());
