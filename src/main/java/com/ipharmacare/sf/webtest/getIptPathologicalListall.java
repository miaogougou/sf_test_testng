...
/**
 * 
 * @ClassName: getIptPathologicalListall 
 * @Description: 获取病理列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptPathologicalListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/pathologicalList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("pathologicalListall form get: " + response.getStatusLine());
