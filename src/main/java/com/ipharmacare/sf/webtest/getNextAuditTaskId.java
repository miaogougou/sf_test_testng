...
/**
 * 
 * @ClassName: getNextAuditTaskId 
 * @Description: 查找下一张审核信息的id
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getNextAuditTaskId {	
	private String url="";
	/**
	 * @Title: geturl 
     ...
     * @throws
     */
    public String getHttpRespone(String id,String type) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/nextAuditTaskId"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("nextAuditTaskId form get: " + response.getStatusLine());
