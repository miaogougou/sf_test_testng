...
/**
 * 
 * @ClassName: getIptSpecialExamListall 
 * @Description: 获取特殊检验列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptSpecialExamListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/specialExamList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("specialExamListall form get: " + response.getStatusLine());
