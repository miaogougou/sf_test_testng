...
/**
 * 
 * @ClassName: getIptProgressListall 
 * @Description: 获取病程记录列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptProgressListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/progressList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("progressListall form get: " + response.getStatusLine());
