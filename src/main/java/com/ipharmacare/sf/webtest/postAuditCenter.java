...
public class postAuditCenter {	
     ...
     * @throws
     */
    public String getHttpRespone(String filename) throws IOException {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/auditcenter");
        ...
        try {
            ...
            try {
                ...
                System.out.println("auditcentert form post: " + response.getStatusLine());
