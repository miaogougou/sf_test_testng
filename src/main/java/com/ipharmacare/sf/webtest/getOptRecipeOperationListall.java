...
public class getOptRecipeOperationListall {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/all/optRecipeOperationList/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("optRecipeOperationListall form get: " + response.getStatusLine());
