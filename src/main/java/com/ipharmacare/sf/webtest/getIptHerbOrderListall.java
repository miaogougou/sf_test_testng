...
/**
 * 
 * @ClassName: getIptHerbOrderListall 
 * @Description: 获取草药医嘱列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptHerbOrderListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/herbOrderList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("herbOrderListall form get: " + response.getStatusLine());
