...
public class getOptEngineMsgList {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/engineMsgList/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("engineMsgList form get: " + response.getStatusLine());
