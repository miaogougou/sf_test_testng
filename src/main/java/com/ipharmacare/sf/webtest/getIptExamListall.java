...
public class getIptExamListall {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/examList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("examListall form get: " + response.getStatusLine());
