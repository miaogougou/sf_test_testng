...
public class getAnalysisExport {	
    ...
    public String getHttpRespone(String projectId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/export"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("analysisExport form get: " + response.getStatusLine());
