...
/**
 * 
 * @ClassName: getIptDrugSensitiveListall 
 * @Description: 获取患者住院就诊信息
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptDrugSensitiveListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/drugSensitiveList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("drugSensitiveListall form get: " + response.getStatusLine());
