...
public class delReplyTemplate {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/deleteReplyTemplate/"+id); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("deleteReplyTemplate form delete: " + response.getStatusLine());
