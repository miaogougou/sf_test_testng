...
/**
 * 
 * @ClassName: getIptNonOrderListall 
 * @Description: 获取非药物医嘱列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptNonOrderListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/nonOrderList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("nonOrderListall form get: " + response.getStatusLine());
