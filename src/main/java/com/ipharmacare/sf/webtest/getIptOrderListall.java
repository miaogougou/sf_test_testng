...
/**
 * 
 * @ClassName: getIptOrderListall 
 * @Description: 获取药物医嘱列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptOrderListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/orderList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("orderListall form get: " + response.getStatusLine());
