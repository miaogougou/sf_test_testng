...
public class getOptNextId {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/opt/nextId"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("nextId form get: " + response.getStatusLine());
