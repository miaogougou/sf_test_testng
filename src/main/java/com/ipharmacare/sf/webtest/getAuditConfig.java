...
/**
 * 
 * @ClassName: getAuditConfig 
 * @Description: 获取配置的审方方案
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getAuditConfig {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/auditConfig"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("auditConfig form get: " + response.getStatusLine());
