...
public class postSaveCheckResult {	
    ...
    public String getHttpRespone(String body) throws IOException {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/ipt/saveCheckResult");
        ...
        try {
            ...
            try {
                ...
                System.out.println("saveCheckResult form post: " + response.getStatusLine());
