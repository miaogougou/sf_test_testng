...
public class getMsgOptPatientList {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/all/msgOptPatientList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("msgOptPatientList form get: " + response.getStatusLine());
