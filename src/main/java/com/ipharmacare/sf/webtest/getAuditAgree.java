...
public class getAuditAgree {	
    ...
    public String getHttpRespone(String id,String auditType) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/auditAgree"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("auditAgree form get: " + response.getStatusLine());
