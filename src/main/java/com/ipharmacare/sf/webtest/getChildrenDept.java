...
public class getChildrenDept {	
    ...
    public String getHttpRespone(String parentid) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/childrenDept"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("childrenDept form get: " + response.getStatusLine());
