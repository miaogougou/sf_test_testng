...
public class getMsg {	
     ...
     * @throws
     */
    public String getHttpRespone(String messageId) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/msg/"+messageId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("msg form get: " + response.getStatusLine());
