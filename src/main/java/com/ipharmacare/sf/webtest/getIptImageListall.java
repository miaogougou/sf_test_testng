...
public class getIptImageListall {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/imageList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("imageListall form get: " + response.getStatusLine());
