...
public class getIptOrderList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/orderList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("orderList form get: " + response.getStatusLine());
