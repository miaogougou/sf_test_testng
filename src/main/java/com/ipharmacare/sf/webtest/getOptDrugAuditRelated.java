...
public class getOptDrugAuditRelated {	
    ...
    public String getHttpRespone(String optRecipeId,String zoneId,String productId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt//drugAuditRelated/"+optRecipeId+"/"+zoneId+"/"+productId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("optdrugAuditRelated form get: " + response.getStatusLine());
