...
public class getAuditWorking {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/auditWorking"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("auditWorking form get: " + response.getStatusLine());
