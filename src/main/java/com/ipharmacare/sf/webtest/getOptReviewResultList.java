...
/**
 * 
 * @ClassName: getOptReviewResultList 
 * @Description:查询个人复合结果详情
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getOptReviewResultList {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String startTime,String endTime,
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/opt/reviewResultList"); 
