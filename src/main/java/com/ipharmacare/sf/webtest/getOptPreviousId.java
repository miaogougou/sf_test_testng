...
/**
 * 
 * @ClassName: getOptPreviousId 
 * @Description: 获取下一条处方id
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getOptPreviousId {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/opt/previousId"); 
        
        try {
        	HttpUriRequest req = RequestBuilder.get()
                    .setUri(new URI(url))
                    .addParameter("optRecipeId", optRecipeId)
                    .build();
        	CloseableHttpResponse response = httpclient.execute(req);
            try {
            	HttpEntity entity = response.getEntity();
            	
                System.out.println("previousId form get: " + response.getStatusLine());
