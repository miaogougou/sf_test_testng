...
public class getIptOperationList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/operationList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("operationList form get: " + response.getStatusLine());
