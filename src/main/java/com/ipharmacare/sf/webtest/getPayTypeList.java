...
public class getPayTypeList {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/payTypeList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("payTypeList form get: " + response.getStatusLine());
