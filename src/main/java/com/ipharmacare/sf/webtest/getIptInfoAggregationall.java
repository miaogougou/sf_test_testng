...
/**
 * 
 * @ClassName: getIptInfoAggregationall 
 * @Description: 获取住院汇总
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptInfoAggregationall {	
	private String url="";
	/**
	 * @Title: geturl 
     ...
     * @throws
     */
    public String getHttpRespone(String id,String startDate,String period) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/iptInfoAggregation"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("iptInfoAggregationall form get: " + response.getStatusLine());
