...
public class getWorkStatistics {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/workStatistics"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("workStatistics form get: " + response.getStatusLine());
