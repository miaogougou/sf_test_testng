...
public class getCheckIptOrderData {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/ipt/checkIptOrderData"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("checkIptOrderData form get: " + response.getStatusLine());
