...
public class getOptRecipeExamList {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/optRecipeExamList/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("optRecipeExamList form get: " + response.getStatusLine());
