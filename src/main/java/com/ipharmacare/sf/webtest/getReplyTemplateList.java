...
public class getReplyTemplateList {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/replyTemplateList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("replyTemplateList form get: " + response.getStatusLine());
