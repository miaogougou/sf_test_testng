...
/**
 * 
 * @ClassName: getIptRecordListall 
 * @Description: 获取入院记录列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptRecordListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/iptRecordList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("iptRecordListall form get: " + response.getStatusLine());
