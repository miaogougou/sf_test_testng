...
/**
 * 
 * @ClassName: putAuditBeating 
 * @Description: 审核药师工作状态心跳
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class putAuditBeating {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/auditBeating"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("AuditBeating form get: " + response.getStatusLine());
