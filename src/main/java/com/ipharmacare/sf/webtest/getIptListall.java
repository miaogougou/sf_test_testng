...
/**
 * 
 * @ClassName: getIptListall 
 * @Description: 获取已审核住院列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/iptList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("iptListall form get: " + response.getStatusLine());
