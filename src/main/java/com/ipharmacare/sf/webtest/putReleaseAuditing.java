...
/**
 * 
 * @ClassName: putReleaseAuditing 
 * @Description: 结束正在审核的任务
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class putReleaseAuditing {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/releaseAuditing"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("ReleaseAuditing form get: " + response.getStatusLine());
