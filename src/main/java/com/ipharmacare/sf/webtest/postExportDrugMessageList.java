...
/**
 * 
 * @ClassName: postExportDrugMessageList 
 * @Description: 保存项目
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 下午3:07:39 
 *
 */
public class postExportDrugMessageList {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String body) throws IOException {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/exportDrugMessageList");
        ...
        try {
            ...
            try {
                ...
                System.out.println("exportDrugMessageList form post: " + response.getStatusLine());
