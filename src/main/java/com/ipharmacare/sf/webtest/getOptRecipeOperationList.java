...
public class getOptRecipeOperationList {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/optOperationList/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("optRecipeOperationList form get: " + response.getStatusLine());
