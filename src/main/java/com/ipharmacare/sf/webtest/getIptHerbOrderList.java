...
public class getIptHerbOrderList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/herbOrderList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("herbOrderList form get: " + response.getStatusLine());
