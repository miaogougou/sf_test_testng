...
/**
 * 
 * @ClassName: getIptCheckResult 
 * @Description: 获取一组药的复核结果
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptCheckResult {	
	private String url="";
	/**
	 * @Title: geturl 
     ...
     * @throws
     */
    public String getHttpRespone(String projectId,String engineId,String groupNo) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/ipt/getCheckResult"); 
        ...
        try {
        	HttpUriRequest req = RequestBuilder.get()
                    ...
                    .addParameter("groupNo", groupNo)
                    .build();
        	CloseableHttpResponse response = httpclient.execute(req);
            try {
            	HttpEntity entity = response.getEntity();
            	
                System.out.println("getCheckResult form get: " + response.getStatusLine());
