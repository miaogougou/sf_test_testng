...
/**
 * 
 * @ClassName: getIptOperationListall 
 * @Description: 获取手术列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptOperationListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/operationList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("operationListall form get: " + response.getStatusLine());
