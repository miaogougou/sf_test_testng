...
public class getIptPatientall {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/iptPatient"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("iptPatientall form get: " + response.getStatusLine());
