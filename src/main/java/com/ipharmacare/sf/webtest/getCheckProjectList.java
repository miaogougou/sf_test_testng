...
/**
 * 
 * @ClassName: getCheckProjectList 
 * @Description: 获取复核项目列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getCheckProjectList {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/checkProjectList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("getCheckProjectList form get: " + response.getStatusLine());
