...
/**
 * 
 * @ClassName: getIptReviewResultList 
 * @Description:查询医嘱个人复合结果详情
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptReviewResultList {	
	private String url="";
	/**
	 * @Title: geturl 
     ...
     * @throws
     */
    public String getHttpRespone(String startTime,String endTime,
			                     String page,String pageSize,
								 String checkPeopleName,
								 String checkResult,String source) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/ipt/reviewResultList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("reviewResultList form get: " + response.getStatusLine());
