...
/**
 * 
 * @ClassName: postAuditBatchRefuse 
 * @Description: 批量打回处方
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 下午3:07:39 
 *
 */
public class postAuditBatchRefuse {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String body) throws IOException {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/auditBatchRefuse");
        ...
        try {
            ...
            try {
                ...
                System.out.println("auditBatchRefuse form post: " + response.getStatusLine());
