...
public class getOptDrugAuditRelatedall {	
     ...
     * @throws
     */
    public String getHttpRespone(String optRecipeId,String zoneId,String productId) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/all/drugAuditRelated/"+optRecipeId+"/"+zoneId+"/"+productId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("optdrugAuditRelatedall form get: " + response.getStatusLine());
