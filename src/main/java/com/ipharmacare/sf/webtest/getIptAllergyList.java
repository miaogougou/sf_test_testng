...
public class getIptAllergyList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/allergyList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("allergyList form get: " + response.getStatusLine());
