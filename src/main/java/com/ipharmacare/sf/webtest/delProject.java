...
public class delProject {	
    ...
    public String getHttpRespone(String projectId,String source) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/deleteProject"); 
        
        try {
        	HttpUriRequest req = RequestBuilder.delete()
                    .setUri(new URI(url))
            ...
            try {
                ...
                System.out.println("deleteProjectMap form delete: " + response.getStatusLine());
