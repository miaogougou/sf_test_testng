...
public class getMedicationInfoExport {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/medicationinfo/export"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("medicationinfoexport form get: " + response.getStatusLine());
