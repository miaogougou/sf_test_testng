...
public class getOptAuditResultList {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/auditResultList/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("auditResultList form get: " + response.getStatusLine());
