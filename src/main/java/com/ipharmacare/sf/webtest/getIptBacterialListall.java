...
/**
 * 
 * @ClassName: getIptBacterialListall 
 * @Description: 获取细菌培养列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptBacterialListall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/bacterialList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("bacterialListall form get: " + response.getStatusLine());
