...
public class getChildIcd10 {	
    ...
    public String getHttpRespone(String parentid) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/childIcd10"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("childIcd10 form get: " + response.getStatusLine());
