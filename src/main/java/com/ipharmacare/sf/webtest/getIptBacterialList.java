...
public class getIptBacterialList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/bacterialList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("bacterialList form get: " + response.getStatusLine());
