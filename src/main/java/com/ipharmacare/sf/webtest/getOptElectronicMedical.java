...
public class getOptElectronicMedical {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/optElectronicMedical/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("optElectronicMedical form get: " + response.getStatusLine());
