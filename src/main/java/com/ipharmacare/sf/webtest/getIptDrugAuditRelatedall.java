...
/**
 * 
 * @ClassName: getIptDrugAuditRelatedall 
 * @Description: 获取关联点
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptDrugAuditRelatedall {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/drugAuditRelated"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("drugAuditRelatedall form get: " + response.getStatusLine());
