...
public class postSaveOperation {	
     ...
     * @throws
     */
    public String getHttpRespone(String body,String projectId) throws IOException {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/opt/saveOperation"+"?projectId="+projectId);
        ...
        try {
            ...
            try {
                ...
                System.out.println("saveOperation form post: " + response.getStatusLine());
