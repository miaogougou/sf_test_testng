...
public class getIptTotalCheckNum {	
    ...
    public String getHttpRespone(String projectId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/ipt/getTotalCheckNum"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("getTotalCheckNum form get: " + response.getStatusLine());
