...
public class getMsgOptRecipeList {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/all/msgOptRecipeList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("msgOptRecipeList form get: " + response.getStatusLine());
