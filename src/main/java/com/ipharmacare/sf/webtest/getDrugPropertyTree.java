...
public class getDrugPropertyTree {	
    ...
    public String getHttpRespone(String keyword) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/drugPropertyTree"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("drugPropertyTree form get: " + response.getStatusLine());
