...
public class getOptRecipeInfoall {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/all/recipeInfo/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("recipeInfoall form get: " + response.getStatusLine());
