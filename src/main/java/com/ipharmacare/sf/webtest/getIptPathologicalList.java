...
/**
 * 
 * @ClassName: getIptPathologicalList 
 * @Description: 获取病理列表
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptPathologicalList {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/pathologicalList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("pathologicalList form get: " + response.getStatusLine());
