...
/**
 * 
 * @ClassName: getPatientCondtionList 
 * @Description: 获取病人类型的信息
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getPatientCondtionList {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/patientCondtionList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("patientCondtionList form get: " + response.getStatusLine());
