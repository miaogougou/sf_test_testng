...
public class getChildDrugProperty {	
    ...
    public String getHttpRespone(String keyword) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/childDrugProperty"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("childDrugProperty form get: " + response.getStatusLine());
