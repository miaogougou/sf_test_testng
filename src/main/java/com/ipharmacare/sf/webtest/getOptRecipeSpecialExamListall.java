...
public class getOptRecipeSpecialExamListall {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/all/optRecipeSpecialExamList/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("optRecipeSpecialExamListall form get: " + response.getStatusLine());
