...
public class getDrugPropertyList {	
    ...
    public String getHttpRespone(String keyword) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/drugPropertyList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("drugPropertyList form get: " + response.getStatusLine());
