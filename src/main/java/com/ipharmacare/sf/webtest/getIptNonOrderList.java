...
public class getIptNonOrderList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/nonOrderList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("nonOrderList form get: " + response.getStatusLine());
