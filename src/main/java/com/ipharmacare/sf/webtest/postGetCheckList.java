...
public class postGetCheckList {	
    ...
    public String getHttpRespone(String body) throws IOException {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/opt/getCheckList");
        ...
        try {
            ...
            try {
                ...
                System.out.println("getCheckList form post: " + response.getStatusLine());
