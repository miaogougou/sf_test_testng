...
public class getIptDrugSensitiveList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/drugSensitiveList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("drugSensitiveList form get: " + response.getStatusLine());
