...
public class getDrugCategory {	
    ...
    public String getHttpRespone(String keyword) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/drugCategory"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("drugCategory form get: " + response.getStatusLine());
