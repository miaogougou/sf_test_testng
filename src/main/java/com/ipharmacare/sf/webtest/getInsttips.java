...
public class getInsttips {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/getInsttips"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("getInsttips form get: " + response.getStatusLine());
