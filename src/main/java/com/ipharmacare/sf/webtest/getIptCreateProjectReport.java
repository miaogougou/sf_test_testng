...
public class getIptCreateProjectReport {	
     ...
     * @throws
     */
    public String getHttpRespone(String projectId) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/ipt/createProjectReport"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("createProjectReport form get: " + response.getStatusLine());
