...
public class getIptMsgPatientList {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/iptMsgPatientList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("iptMsgPatientList form get: " + response.getStatusLine());
