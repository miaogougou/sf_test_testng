...
public class getOptRecipeElectronicMedicalall {	
     ...
     * @throws
     */
    public String getHttpRespone(String optRecipeId) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/all/optRecipeElectronicMedical/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("optRecipeElectronicMedicalall form get: " + response.getStatusLine());
