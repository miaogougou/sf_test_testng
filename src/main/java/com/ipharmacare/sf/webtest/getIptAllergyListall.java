...
public class getIptAllergyListall {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/all/allergyList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("allergyListall form get: " + response.getStatusLine());
