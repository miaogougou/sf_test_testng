...
public class getIptNextEngineId {	
    ...
    public String getHttpRespone(String engineId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/ipt/getNextEngineId"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("getNextEngineId form get: " + response.getStatusLine());
