...
public class getCheckAuditPlanName {	
     ...
     * @throws
     */
    public String getHttpRespone(String planname) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/checkAuditPlanName"); 
        
        try {
        	HttpUriRequest req = RequestBuilder.get()
                    .setUri(new URI(url))
                    .addParameter("name", planname)
                    .build();
            ...
            try {
                ...
                System.out.println("checkAuditPlanName form get: " + response.getStatusLine());
