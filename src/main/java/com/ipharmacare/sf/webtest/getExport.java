...
public class getExport {	
     ...
     * @throws
     */
    public String getHttpRespone(String taskId) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/export/"+taskId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("export form get: " + response.getStatusLine());
