...
public class getOptAuditResultListall {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/all/auditResultList/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("auditResultListall form get: " + response.getStatusLine());
