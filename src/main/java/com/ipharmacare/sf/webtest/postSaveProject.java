...
public class postSaveProject {	
     ...
     * @throws
     */
    public String getHttpRespone(String body,String projectName) throws IOException {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/saveProject"+"?projectName="+projectName);
        ...
        try {
            ...
            try {
                ...
                System.out.println("saveProject form post: " + response.getStatusLine());
