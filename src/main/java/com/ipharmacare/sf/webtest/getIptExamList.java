...
public class getIptExamList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/examList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("examList form get: " + response.getStatusLine());
