...
public class getIptRecordList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/iptRecordList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("iptRecordList form get: " + response.getStatusLine());
