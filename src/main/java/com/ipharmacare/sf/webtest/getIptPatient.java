...
public class getIptPatient {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/iptPatient"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("iptPatient form get: " + response.getStatusLine());
