...
public class getIptWardList {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/iptWardList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("iptWardList form get: " + response.getStatusLine());
