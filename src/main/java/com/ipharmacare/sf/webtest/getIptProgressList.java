...
public class getIptProgressList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/progressList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("progressList form get: " + response.getStatusLine());
