...
public class getOptRecipeImageList {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/opt/optRecipeImageList/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("optRecipeImageList form get: " + response.getStatusLine());
