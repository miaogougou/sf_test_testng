...
public class getIptSpecialExamList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/specialExamList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("specialExamList form get: " + response.getStatusLine());
