...
public class getWorkStatisticsExport {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/workStatistics/export"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("workStatisticsExport form get: " + response.getStatusLine());
