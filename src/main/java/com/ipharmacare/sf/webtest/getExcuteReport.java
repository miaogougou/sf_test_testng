...
public class getExcuteReport {	
     ...
     * @throws
     */
    public String getHttpRespone(String projectId,String source) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/excuteReport"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("excuteReport form get: " + response.getStatusLine());
