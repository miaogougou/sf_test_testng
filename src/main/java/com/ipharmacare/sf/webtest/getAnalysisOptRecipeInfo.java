...
public class getAnalysisOptRecipeInfo {	
    ...
    public String getHttpRespone(String optRecipeId) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/opt/recipeInfo/"+optRecipeId); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("recipeInfo form get: " + response.getStatusLine());
