...
public class getAuditDoctorList {	
    ...
    public String getHttpRespone() throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/auditDoctorList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("auditDoctorList form get: " + response.getStatusLine());
