...
/**
 * 
 * @ClassName: postAuditBatchPending 
 * @Description: 批量通过处方
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 下午3:07:39 
 *
 */
public class postAuditBatchPending {	
	private String url="";
	/**
	 * @Title: geturl 
    ...
    public String getHttpRespone(String body) throws IOException {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/batchPending");
        ...
        try {
            ...
            try {
                ...
                System.out.println("auditBatchPending form post: " + response.getStatusLine());
