...
/**
 * 
 * @ClassName: getIptPreviousEngineId 
 * @Description: 获取上一条记录
 * @author DaiJunjun daijj@ipharmacare.net
 * @date 2017年4月19日 上午11:30:19 
 *
 */
public class getIptPreviousEngineId {	
	private String url="";
	/**
	 * @Title: geturl 
     ...
     * @throws
     */
    public String getHttpRespone(String engineId) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/analysis/ipt/getPreviousEngineId"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("getPreviousEngineId form get: " + response.getStatusLine());
