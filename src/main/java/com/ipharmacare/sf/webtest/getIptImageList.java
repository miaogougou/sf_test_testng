...
public class getIptImageList {	
    ...
    public String getHttpRespone(String id) throws Exception {
        ...
        CloseableHttpClient httpclient = HttpClients.custom()
                ...
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/ipt/imageList"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("imageList form get: " + response.getStatusLine());
