...
public class getChildDrugCategory {	
     ...
     * @throws
     */
    public String getHttpRespone(String parentid) throws Exception {
    	BasicCookieStore cookieStore = RequestCookiestore.getRequestCookies();
        CloseableHttpClient httpclient = HttpClients.custom()
                .setDefaultCookieStore(cookieStore)
                .build();
        url=GetRequestUrl.getRequestUrl("/api/v1/childDrugCategory"); 
        ...
        try {
            ...
            try {
                ...
                System.out.println("childDrugCategory form get: " + response.getStatusLine());
